...
<div class="property-area pd-top-30">
  ...
  //                  array_push($array_path_img_sm,image_style_url('900 x 800', $cacanh['uri']));
            ...
            ?>
            <div class="border-none contact-form-wrap-1 main-summary-project mb-30">
                <div class="row">
                  <div class="col-md-7">
                            ...
                            <div class="can-giua">
                              ...
                              <div class="content-summary">
                                ...
                                <?php if (!empty($node->field_chu_dau_tu)):?>
                                  <p><i class="fa fa-user"></i> Chủ đầu tư: <span class="font-weight-600"><?php print $node->field_chu_dau_tu['und'][0]['value'];?></span></p>
                                <?php endif;?>
                                  <?php if ($node->field_don_vi_tinh_1['und'][0]['value'] == 'ha'){
                                      $dvt = 'ha';
                                  }else{
                                      $dvt = 'm<sup>2</sup>';
                                  }?>
                                <p><i class="fas fa-expand" aria-hidden="true"></i> Tổng diện tích: <span class="font-weight-600"><?php print $node->field_tong_dien_tich_khu_dat['und'][0]['value'].$dvt?> </span></p>
                                <p class="price">
                                  <?php if (!empty($node->field_gia_bang_chu)):?>
                                <h6 class="price"><i class="fa fa-money-bill"></i><span class="pri"><?=isset($node->field_gia_bang_chu['und'][0]['value']) ? $node->field_gia_bang_chu['und'][0]['value'] : '' ?></span> </h6>
                              <?php else:?>
                                <?php isset($node->field_gia_san_pham_tu['und'][0]['value']) ? print '<i class="fa fa-money-bill"></i><span class="pri"> Giá : <span class="pri">'.number_format($node->field_gia_san_pham_tu['und'][0]['value'],'0','.','.').' đ</span>': print '';
                              ...
                              <a class="btn btn-primary" href="tel:0789758999">Quan tâm</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-md-<?= $col?>">
              ...
              <?php if(!((arg(0)=='admin')&&(arg(1)=='people'))):?>
                <?php if ($tabs): ?><div class="tabs"><?php print render($tabs); ?></div><?php endif; ?>
                <?php print render($page['help']); ?>
                <?php if ($action_links): ?><ul class="action-links"><?php print render($action_links); ?></ul><?php endif; ?>
              <?php endif;?>

              <?php if((arg(0)=='admin')&&(arg(1)=='people')&&(arg(2)=='permissions')&&(arg(3)=='roles')):?>
                <?php print str_replace('draggable even','',str_replace('class="sticky-enabled','class="table table-responsive table-striped',
                  render($page['content']))); ?>
              <?php else:?>
