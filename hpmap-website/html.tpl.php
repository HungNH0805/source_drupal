...
<head>
  ...
  <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDhCls1wV7JTQHSfBcOvLjqdUNMdPmF0R0"></script>
</head>

<body>
<input type="hidden" id="input-uid" value="<?= $user->uid ?>">
