        ...
        success: function (data) {
          ...
          if($("#block-block-12").length > 0){
            require([
              ...
              esriConfig.apiKey = "AAPK3e5990abf0eb4ddc85ce5776943cbcc7KrLptUnOIT1zRnHXg9MngxirG_N_BSk-iEY__lvYqfRWEZDlPkHx8Ked9aZsZ9Ud";
              ...
              const view = new MapView({
                map: map,
                center: [106.691932, 20.819190 ], // Longitude, latitude
                zoom: 13, // Zoom level
