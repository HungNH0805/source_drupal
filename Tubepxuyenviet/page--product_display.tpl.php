            ...
            <div class="row">
                ...
                <div class="col-md-<?= $col ?> order-1">
                  ...
                  <div class="content-page">
                    <div class="row">
                      <div class="col-md-6">
                        <h2 class="title_dang_ki_thong_tin">Đăng kí thông tin</h2>
                        <ul class="content-contact">
                          <li><i class="fas fa-check"></i> So sánh chi phí hoàn thiện bộ tủ bếp nhựa và tủ bếp gỗ</li>
                          <li><i class="fas fa-check"></i> Giá tủ bếp nhựa hiện nay</li>
                          <li><i class="fas fa-check"></i> Tủ bếp laminate - Ưu và nhược điểm</li>
                          <li><i class="fas fa-check"></i> Tủ bếp sơn phủ men bóng ôtô - Ưu và nhược điểm</li>
                          <li><i class="fas fa-check"></i> Thiết kế tủ bếp đẹp</li>
                        </ul>
                      </div>
                      <div class="col-md-6">
                        <?php
                        webform_node_view(node_load(2423), 'full');
                        print theme_webform_view(node_load(2423)->content);
                        ?>
                      </div>
                    </div>
                  </div>
