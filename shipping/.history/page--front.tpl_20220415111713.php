...
<div class="offset-menu">
  ...
  <div class="offset-menu-wrapper text-white">
    ...
    <div class="offset-menu-section">
      ...
      <a href="tel:0904441068" class="theme-btn minimal-btn mt-30">Gọi ngay <i class="fas fa-arrow-right"></i></a>
    </div> <!-- /.offset-menu-section -->
    <div class="offset-menu-section">
      <h3>THÔNG TIN LIÊN HỆ</h3>
      <ul>
        <li><span><i class="fal fa-map"></i></span>Phòng 406, TD Business Center, Lô 20A, Lê Hồng Phong, Đông Khê, Ngô Quyền, Hải Phòng, Việt Nam</li>
        ...
        <li><span><i class="fal fa-clock"></i></span>Thời gian hoạt động: 8.00 - 17.00</li>
      </ul>
    </div> <!-- /.offset-menu-section -->
              ...
              <div class="mobile-nav">
                ...
                <div class="action-bar text-white">
                  <div class="single-info-element">
                    ...
                    <div class="text">
                      <h5>Địa chỉ:</h5>
                      <span>Phòng 406, TD Business Center, Lô 20A, Lê Hồng Phong, Đông Khê, Ngô Quyền, HP</span>
                    </div>
                  </div>
                  <div class="single-info-element">
                    <div class="icon">
                  ...
                  <a href="tel:0904441068" class="theme-btn mt-4">Gọi Ngay</a>
                </div>
              </div>
            </div>
            ...
            <div class="get-in-touch">
              <div class="single-contact-info">
                ...
                <div class="contact-info">
                  <span>Phòng 406, TD Business Center, Lô 20A, Lê Hồng Phong, Hải Phòng</span>
                </div>
              </div>
              <div class="single-contact-info">
                <div class="icon id2">
