...
<div class="top-bar-wrapper d-none d-sm-block">
  <div class="container d-flex justify-content-between align-items-center">
    <div class="top-left">
      <a href="tel:0904441068"><i class="fal fa-phone-volume"></i>0904.441.068</a>
      <a href="mailto:info@example.com"><i class="fal fa-envelope"></i>info@topshipping.vn</a>
      <a href="#"><i class="fal fa-map-marker-alt"></i>Phòng 406, TD Business Center, Lô 20A, Lê Hồng Phong, Hải Phòng</a>
    </div>
      ...
      <div class="row align-items-center justify-content-between">
        ...
        <div class="col-lg-9 text-end p-lg-0 d-none d-lg-flex justify-content-between align-items-center">
          ...
          <div class="header-right-element">
            <a href="tel:0904441068" class="theme-btn">Gọi ngay<i class="fal fa-long-arrow-right"></i></a>
    ...
    <div class="row">
        ...
        <div class="single-contact-card card2">
          ...
          <div class="bottom-part">
            <div class="info">
              ...
              <p><a href="tel:0342423423">0342423423</a></p>
            </div>
            <div class="icon">
              <i class="fal fa-arrow-right"></i>
            </div>
      ...
      <div class="col-lg-4 col-md-6 col-12">
        <div class="single-contact-card card3">
          ...
          <div class="bottom-part">
            <div class="info">
              <p>Phòng 406, TD Business Center, Lô 20A, Lê Hồng Phong, HP</p>
            </div>
            <div class="icon">
              <i class="fal fa-arrow-right"></i>
            </div>
