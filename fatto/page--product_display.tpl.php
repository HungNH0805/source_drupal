<div class="wrapper">
    ...
    <header>
      <div class="container">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item " aria-current="page"><?= $node->title ?></li>
        </ol>
  ...
  <?php print views_embed_view('sidebar_tin_tuc', 'block_sp_not_bat'); ?>
